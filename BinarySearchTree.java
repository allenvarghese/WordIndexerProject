...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    public LinkedList<AnyType> convertTree()
    {
    ...
    private void convertTree(BinaryNode<AnyType> t, LinkedList<AnyType> linkedlist)
    {
    	if(t.left != null)
    		convertTree(t.left, linkedlist);
    	linkedlist.add(t.element);
    	if(t.right != null)
    		convertTree(t.right, linkedlist);
    }
    ...
    public BinaryNode<AnyType> get( AnyType x ) { return get( x, root ); }
    
    private BinaryNode<AnyType> get( AnyType x, BinaryNode<AnyType> t )
    {
        if( t == null )
